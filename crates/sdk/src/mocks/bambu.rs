                    ...
                    while let Ok(n) = stream.read(&mut buffer) {
                        ...
                        match packet_type {
                            ...
                            8 => {
                                ...
                                thread::spawn(move || {
                                    while running_telemetry.load(Ordering::Relaxed) {
                                        ...
                                        if stream_clone.write_all(&pkt).is_err() {
                                            break;
                                        }
                            ...
                            12 => {
                                ...
                                let _ = stream.write_all(&pingresp);
                            }
                            _ => {}
                        }
                    }
