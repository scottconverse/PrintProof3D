...
### B. Forbidden-Language & Semantic Scan Verdict
To ensure continuous compliance, an automated compliance tool `devtools/docs_policy_check.py` has been implemented and wired directly into the GitHub Actions CI workflow and local development health checks. It targets all user-facing documentation and HTML pages.
