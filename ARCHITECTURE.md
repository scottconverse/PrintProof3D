...
* **`printproof3d-adapters`**: The physical printer connection protocol layer. It defines the asynchronous `PrinterAdapter` trait and houses connection configurations. Concrete adapter clients are implemented and verified against simulator twin mocks. No physical-printer validation or hardware certification is claimed.
