...
* **`printproof3d-adapters`**: The physical printer connection protocol layer. It defines the asynchronous `PrinterAdapter` trait and houses connection configurations. *Note: OctoPrint and Moonraker/Klipper adapters are defined as trait stubs and configuration outlines for future implementation; they do not have active connection clients in this release.*
